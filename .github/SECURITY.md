...
We take the security of the Nexus Exchange API spec seriously.

## Reporting a vulnerability

**Please report security vulnerabilities privately** using GitHub's
[**Report a vulnerability**](https://github.com/nexus-xyz/nexus-exchange-api/security/advisories/new)
...
security vulnerability — that discloses it before a fix is available.

We'll acknowledge your report as quickly as we can and keep you updated on the
fix and any coordinated disclosure.

For general spec inaccuracies or non-security bugs, use the regular
